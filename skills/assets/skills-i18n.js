(() => {
  const dict = {
    en: {
      ...
      "skills.registry.title": "Two candidates. Zero admitted skills.",
      ...
      "skills.cases.title": "Available evaluation cases.",
    ...
    uk: {
      ...
      "skills.lede": "Публічна доказова поверхня для кандидатів повторно використовуваних процесів. Генерація, наявність репозиторію й успішні тести не допускають навичку.",
      ...
      "skills.boundary.body": "Codex може виділити або згенерувати кандидата. Потрібне окреме рішення перегляду. Тут немає допущених навичок чи чинного маркетплейсу.",
      "skills.registry.title": "Два кандидати. Нуль допущених навичок.",
      ...
      "skills.cases.title": "Наявні випадки оцінювання.",
      ...
      "skills.market.body": "Спочатку мають існувати допуск, встановлення, версіонування, оцінка, походження, дозволи, попит, оплата, юридичні й операторські контракти."
    },
    ru: {
      ...
      "skills.registry.title": "Два кандидата. Ноль допущенных навыков.",
      ...
      "skills.cases.title": "Доступные случаи оценки.",
